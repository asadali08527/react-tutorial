...
const VideoTitle = ({mainMovie}) => {
  ...
  return (
    <div className='pt-36 px-12 absolute text-white bg-gradient-to-r from-black w-screen aspect-video'>
        <br/>
        <h1 className='text-6xl font-bold'>{original_title}</h1><br />
        <p className="py-6 text-lg w-1/4 justify-evenly"> {overview}</p>
        
        <div>
            <button className='bg-white text-black p-4 px-10 py-2 w-100 text-lg fa-solid fa-play rounded-lg hover:opacity-80'>
            ...
            <button onClick={handleMoreInfoClick} className='bg-gray-500 text-white mx-4 my-8 pt-6 pb-2 px-4 py-2 w-[134px] text-lg rounded-lg bg-opacity-50 text-center'>
