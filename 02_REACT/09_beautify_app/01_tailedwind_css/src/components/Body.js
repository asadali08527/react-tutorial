        ...
        <div className="body">
            <div className="filter flex"> 
                <div className="search m-4 p-4">
                    <input type="text" className="border border-solid border-black " value={searchTerm} onChange={(e) => {
            ...
            <div className="flex flex-wrap"> 
                ...
                filteredRestaurantList.length?
                    ...
                    restaurantList.map(rest => 
                       <Link key={rest.card.card.info.id} to={"/restaurants/"+rest.card.card.restaurant.info.id}> <RestaurantCard  restData={rest}/></Link>
                       )
                }      
            </div>
        </div>
